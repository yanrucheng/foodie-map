...
function props(records: MapShellProps["restaurants"], spatialContext?: SpatialContext): MapShellProps {
  return { selection: null, onRestaurantSelect() {}, onRestaurantClose() {}, restaurants: records, visibleRestaurants: records, spatialContext, groups: [], dataGroups: new Set(["OTHER"]), activeGroups: new Set(["OTHER"]),
    onSelectAll() {}, onDeselectAll() {}, filtersReady: true, showStarFilter: false, starFilter: "all", onStarFilterChange() {}, onToggleGroup() {}, diningCounts: { staple: 0, meat: 0, seafood: 0, dessert_drink: 0, french: 0, chinese: 0, japanese_course: 0, other: 0, unclassified: 0 }, diningFilter: "all", onDiningFilterChange() {}, center: [22.3, 114.17], zoom: 12 };
}
